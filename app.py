...
Created by: Harshavardhan J
Modified on: 20th January 2026
...
gpt_model = 'gpt-4o-mini' #'gpt-3.5-turbo-0613'
...
def main():
    ...
    if submit and uploaded_file_1 and uploaded_file_2:
        with st.spinner("Comparing Documents.....Please Wait"):
            ...
            if spec_list_1:
                try:
                    data = safe_json_loads(spec_list_1)
                    # st.write(data)
            ...
            if data:
                ...
                st.error("No comparison data generated. Model may have returned invalid JSON.")
